...
export default  function Page() {
    ...
    return (
        <div className='mx-auto w-[50%]  mb-8'>
            <Link href='/' className='border font-semibold bg-stone-900 hover:bg-white hover:text-black flex justify-center rounded-md px-2 py-1 my-2'>Back</Link>
            <div className='px-8 py-4 bg-stone-900 rounded-md'>
                <h1 className='text-center font-bold text-3xl'>Create Expense</h1>
                <form onSubmit={onSubmitChange} className="">
                    <div className="flex flex-col">
                        <label className='mb-2'>Category</label>
                        <select id="category_id"
                            name="category_id"
                            value={expenseField.category_id}
                    ...
                    <div className="flex flex-col">
                        ...
                        <select id="payment_method"
                            name="payment_method"
                            value={expenseField.payment_method}
                            className='text-black px-2 py-1 rounded-md'
                            onChange={e => changeFieldHandler(e)}
                            required>
                        ...
                        <div className='h-[10%] text-center relative'>
                            ...
                            <div className='relative'>
                                <img className='w-full rounded-md h-52 object-cover'
                                    src={URL.createObjectURL(expenseField.image)} alt={expenseField.image}></img>
